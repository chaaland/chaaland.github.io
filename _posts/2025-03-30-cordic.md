...
Because of our angle schedule, the largest $$\theta$$ that we could compute the hyperbolic sine and cosine for using this method directly is $$\sum_{k=1}^\infty \tanh^{-1}(2^{-k}) \approx 0.95788846$$.<sup>[3](#footnote3)</sup>
