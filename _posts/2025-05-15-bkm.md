...
<div class="widget-container" id="bkm-widget">
  <div class="widget-controls">
    <label>
      Iterations
      <input type="range" min="1" max="12" value="4" step="1" data-param="iters">
      <span class="widget-readout" data-readout="iters">4</span>
    </label>
    <button type="button" class="widget-button" id="bkm-reset">Reset</button>
  </div>
  <svg class="widget-plot" id="bkm-svg" viewBox="0 0 600 400" preserveAspectRatio="xMidYMid meet">
  ...
  <div class="widget-legend">
    <span class="widget-legend-item"><span class="widget-legend-swatch" style="background:#58a6ff"></span>log(x)</span>
    <span class="widget-legend-item"><span class="widget-legend-swatch" style="background:#7ee787"></span>BKM approximation</span>
  </div>
  <div class="widget-info" id="bkm-info">
...
If we zoom out on this approximation, we see the algorithm only converges for a fixed interval of inputs as shown in Figure 3.
...
<div class="widget-container" id="bkm-exp-widget">
  <div class="widget-controls">
    <label>
      Iterations
      <input type="range" min="1" max="12" value="4" step="1" data-param="exp-iters">
      <span class="widget-readout" data-readout="exp-iters">4</span>
    </label>
    <button type="button" class="widget-button" id="bkm-exp-reset">Reset</button>
  </div>
  <svg class="widget-plot" id="bkm-exp-svg" viewBox="0 0 600 400" preserveAspectRatio="xMidYMid meet">
    <rect x="0" y="0" width="600" height="400" fill="#0d1117"></rect>
    <g id="bkm-exp-grid"></g>
    <g id="bkm-exp-axes"></g>
  ...
  <div class="widget-legend">
    <span class="widget-legend-item"><span class="widget-legend-swatch" style="background:#58a6ff"></span>e<sup>x</sup></span>
    <span class="widget-legend-item"><span class="widget-legend-swatch" style="background:#f78166"></span>BKM approximation</span>
  </div>
  <div class="widget-info" id="bkm-exp-info">
    Iterations: 4 | The approximation has 2<sup>4</sup> = 16 distinct levels
  </div>
...
Figure 6 shows how outside the interval $$[0, 1.562)$$, BKM will fail to compute a correct answer.[^fn1]
...
[^fn1]: The interval comes directly from the logarithm of the interval endpoints for L-mode BKM, namely [1, 4.768]
